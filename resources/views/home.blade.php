<x-layout>
  ...
  <div class="container mx-auto px-6 py-12">
      ...
      <!-- Sambutan -->
      <div 
        class="text-center mb-10 opacity-0 translate-y-6 transition-all duration-1000 ease-out"
        x-data="{ show: false }"
        x-init="setTimeout(() => show = true, 200)"
        x-bind:class="show ? 'opacity-100 translate-y-0' : ''"
      >
          <h1 class="text-4xl font-bold text-gray-800 mb-4">Selamat Datang di <span class="text-indigo-600">Light in Letters</span> ✨📜</h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <!-- Card Users -->
          <div 
            class="bg-white shadow-lg rounded-2xl p-6 text-center hover:scale-105 transition opacity-0 translate-x-6"
            x-data="{ show: false }"
      ...
      <!-- Ajakan -->
      <div 
        class="text-center mt-12 opacity-0 translate-y-6 transition-all duration-1000 ease-out"
        x-data="{ show: false }"
